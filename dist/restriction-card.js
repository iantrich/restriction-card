 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const V=(t,...e)=>new y(t,e,"html",T),Y=133;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const dt=new WeakMap,ht=(t=>(...s)=>{const n=t(...s);return e.set(n,!0),n})(t=>e=>{if(!(e instanceof b)||e instanceof N||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:s}=e,{element:n}=s;dt.has(e)||(n.className=s.strings.join(" "));const{classList:i}=n,r=dt.get(e);for(const e in r)e in t||i.remove(e);for(const e in t){const s=t[e];if(!r||s!==r[e]){i[s?"add":"remove"](e)}}dt.set(e,t)});var ut={},pt=/d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,mt="[^\\s]+",ft=/\[([^]*?)\]/gm,gt=function(){};function _t(t,e){for(var s=[],n=0,i=t.length;n<i;n++)s.push(t[n].substr(0,e));return s}function yt(t){return function(e,s,n){var i=n[t].indexOf(s.charAt(0).toUpperCase()+s.substr(1).toLowerCase());~i&&(e.month=i)}}function vt(t,e){for(t=String(t),e=e||2;t.length<e;)t="0"+t;return t}var St=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],wt=["January","February","March","April","May","June","July","August","September","October","November","December"],bt=_t(wt,3),xt=_t(St,3);ut.i18n={dayNamesShort:xt,dayNames:St,monthNamesShort:bt,monthNames:wt,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10)*t%10]}};var Pt={D:function(t){return t.getDate()},DD:function(t){return vt(t.getDate())},Do:function(t,e){return e.DoFn(t.getDate())},d:function(t){return t.getDay()},dd:function(t){return vt(t.getDay())},ddd:function(t,e){return e.dayNamesShort[t.getDay()]},dddd:function(t,e){return e.dayNames[t.getDay()]},M:function(t){return t.getMonth()+1},MM:function(t){return vt(t.getMonth()+1)},MMM:function(t,e){return e.monthNamesShort[t.getMonth()]},MMMM:function(t,e){return e.monthNames[t.getMonth()]},YY:function(t){return vt(String(t.getFullYear()),4).substr(2)},YYYY:function(t){return vt(t.getFullYear(),4)},h:function(t){return t.getHours()%12||12},hh:function(t){return vt(t.getHours()%12||12)},H:function(t){return t.getHours()},HH:function(t){return vt(t.getHours())},m:function(t){return t.getMinutes()},mm:function(t){return vt(t.getMinutes())},s:function(t){return t.getSeconds()},ss:function(t){return vt(t.getSeconds())},S:function(t){return Math.round(t.getMilliseconds()/100)},SS:function(t){return vt(Math.round(t.getMilliseconds()/10),2)},SSS:function(t){return vt(t.getMilliseconds(),3)},a:function(t,e){return t.getHours()<12?e.amPm[0]:e.amPm[1]},A:function(t,e){return t.getHours()<12?e.amPm[0].toUpperCase():e.amPm[1].toUpperCase()},ZZ:function(t){var e=t.getTimezoneOffset();return(e>0?"-":"+")+vt(100*Math.floor(Math.abs(e)/60)+Math.abs(e)%60,4)}},Ct={D:["\\d\\d?",function(t,e){t.day=e}],Do:["\\d\\d?"+mt,function(t,e){t.day=parseInt(e,10)}],M:["\\d\\d?",function(t,e){t.month=e-1}],YY:["\\d\\d?",function(t,e){var s=+(""+(new Date).getFullYear()).substr(0,2);t.year=""+(e>68?s-1:s)+e}],h:["\\d\\d?",function(t,e){t.hour=e}],m:["\\d\\d?",function(t,e){t.minute=e}],s:["\\d\\d?",function(t,e){t.second=e}],YYYY:["\\d{4}",function(t,e){t.year=e}],S:["\\d",function(t,e){t.millisecond=100*e}],SS:["\\d{2}",function(t,e){t.millisecond=10*e}],SSS:["\\d{3}",function(t,e){t.millisecond=e}],d:["\\d\\d?",gt],ddd:[mt,gt],MMM:[mt,yt("monthNamesShort")],MMMM:[mt,yt("monthNames")],a:[mt,function(t,e,s){var n=e.toLowerCase();n===s.amPm[0]?t.isPm=!1:n===s.amPm[1]&&(t.isPm=!0)}],ZZ:["[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z",function(t,e){var s,n=(e+"").match(/([+-]|\d\d)/gi);n&&(s=60*n[1]+parseInt(n[2],10),t.timezoneOffset="+"===n[0]?s:-s)}]};Ct.dd=Ct.d,Ct.dddd=Ct.ddd,Ct.DD=Ct.D,Ct.mm=Ct.m,Ct.hh=Ct.H=Ct.HH=Ct.h,Ct.MM=Ct.M,Ct.ss=Ct.s,Ct.A=Ct.a,ut.masks={default:"ddd MMM DD YYYY HH:mm:ss",shortDate:"M/D/YY",mediumDate:"MMM D, YYYY",longDate:"MMMM D, YYYY",fullDate:"dddd, MMMM D, YYYY",shortTime:"HH:mm",mediumTime:"HH:mm:ss",longTime:"HH:mm:ss.SSS"},ut.format=function(t,e,s){var n=s||ut.i18n;if("number"==typeof t&&(t=new Date(t)),"[object Date]"!==Object.prototype.toString.call(t)||isNaN(t.getTime()))throw new Error("Invalid Date in fecha.format");e=ut.masks[e]||e||ut.masks.default;var i=[];return(e=(e=e.replace(ft,(function(t,e){return i.push(e),"@@@"}))).replace(pt,(function(e){return e in Pt?Pt[e](t,n):e.slice(1,e.length-1)}))).replace(/@@@/g,(function(){return i.shift()}))},ut.parse=function(t,e,s){var n=s||ut.i18n;if("string"!=typeof e)throw new Error("Invalid format in fecha.parse");if(e=ut.masks[e]||e,t.length>1e3)return null;var i={},r=[],o=[];e=e.replace(ft,(function(t,e){return o.push(e),"@@@"}));var a,c=(a=e,a.replace(/[|\\{()[^$+*?.-]/g,"\\$&")).replace(pt,(function(t){if(Ct[t]){var e=Ct[t];return r.push(e[1]),"("+e[0]+")"}return t}));c=c.replace(/@@@/g,(function(){return o.shift()}));var l=t.match(new RegExp(c,"i"));if(!l)return null;for(var d=1;d<l.length;d++)r[d-1](i,l[d],n);var h,u=new Date;return!0===i.isPm&&null!=i.hour&&12!=+i.hour?i.hour=+i.hour+12:!1===i.isPm&&12==+i.hour&&(i.hour=0),null!=i.timezoneOffset?(i.minute=+(i.minute||0)-+i.timezoneOffset,h=new Date(Date.UTC(i.year||u.getFullYear(),i.month||0,i.day||1,i.hour||0,i.minute||0,i.second||0,i.millisecond||0))):h=new Date(i.year||u.getFullYear(),i.month||0,i.day||1,i.hour||0,i.minute||0,i.second||0,i.millisecond||0),h};(function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}})(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}();var Nt=function(t){var e=function(t,e){return s("hui-error-card",{type:"error",error:t,config:e})},s=function(t,s){var n=window.document.createElement(t);try{n.setConfig(s)}catch(n){return console.error(t,n),e(n.message,s)}return n};if(!t||"object"!=typeof t||!t.type||!t.type.startsWith("custom:"))return e("No type configured",t);var n=t.type.substr("custom:".length);if(customElements.get(n))return s(n,t);var i=e("Custom element doesn't exist: "+t.type+".",t);i.style.display="None";var r=setTimeout((function(){i.style.display=""}),2e3);return customElements.whenDefined(t.type).then((function(){clearTimeout(r),function(t,e,s,n){n=n||{},s=null==s?{}:s;var i=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});i.detail=s,t.dispatchEvent(i)}(i,"ll-rebuild",{},i)})),i};let Mt=class extends lt{set hass(t){this._hass=t;const e=this.shadowRoot.querySelector("#card > *");e&&(e.hass=t)}getCardSize(){const t=this.shadowRoot.querySelector("#card > *");return t&&"function"==typeof(e=t).getCardSize?e.getCardSize():1;var e}setConfig(t){if(!t.card)throw new Error("Error in card configuration.");if(t.restrictions&&t.restrictions.pin&&!t.restrictions.pin.code)throw new Error("A pin code is required for pin restrictions");this._config=t}render(){return this._config&&this._hass&&(!this._config.restrictions||!this._config.restrictions.hide||this._config.restrictions.hide.exemptions&&this._config.restrictions.hide.exemptions.some(t=>t.user===this._hass.user.id))?(console.log("blocked: "+Boolean(this._config.restrictions&&this._config.restrictions.block&&(!this._config.restrictions.block.exemptions||!this._config.restrictions.block.exemptions.some(t=>t.user===this._hass.user.id)))),V`
      <div>
        ${this._config.exemptions&&this._config.exemptions.some(t=>t.user===this._hass.user.id)?"":V`
              <div
                @click=${this._handleClick}
                id="overlay"
                class="${ht({blocked:Boolean(this._config.restrictions&&this._config.restrictions.block&&(!this._config.restrictions.block.exemptions||!this._config.restrictions.block.exemptions.some(t=>t.user===this._hass.user.id)))})}"
              >
    ...
    `):V``}renderCard(t){const e=Nt(t);return this._hass&&(e.hass=this._hass),V`
      <div id="card">
        ${e}
      </div>
    ...
    `}};var kt;t([(t,e)=>void 0!==e?nt(kt,t,e):st(kt,t)],Mt.prototype,"_config",void 0),Mt=t([(t=>e=>"function"==typeof e?((t,e)=>(window.customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:s,elements:n}=e;return{kind:s,elements:n,finisher(e){window.customElements.define(t,e)}}})(t,e))("restriction-card")],Mt);
